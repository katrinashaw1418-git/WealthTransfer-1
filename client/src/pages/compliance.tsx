      ...
      <Tabs defaultValue="kyc" className="space-y-6">
        <div className="overflow-x-auto">
          <TabsList className="inline-flex h-auto gap-1 bg-sky-50 border border-sky-200 p-1 rounded-lg min-w-max">
            <TabsTrigger value="kyc" className="text-sky-700 data-[state=active]:bg-sky-500 data-[state=active]:text-white min-w-[120px]">KYC status</TabsTrigger>
            ...
            <TabsTrigger value="risk" className="text-sky-700 data-[state=active]:bg-sky-500 data-[state=active]:text-white min-w-[120px]">Risk profile</TabsTrigger>
          </TabsList>
        </div>
